 ...
 */
final class Version20210726193011 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE daily_prediction (id INT AUTO_INCREMENT NOT NULL, ticker_performance_id INT NOT NULL, setup_id INT NOT NULL, datetime DATETIME NOT NULL, possible_price_hi NUMERIC(11, 2) NOT NULL, possible_price_low NUMERIC(11, 2) NOT NULL, real_price_hi NUMERIC(11, 2) NOT NULL, real_price_low NUMERIC(11, 2) NOT NULL, difference_real_possible_price_hi NUMERIC(11, 2) NOT NULL, difference_real_possible_price_low NUMERIC(11, 2) NOT NULL, accuracy_price_hi_prediction NUMERIC(11, 2) NOT NULL, accuracy_price_low_prediction NUMERIC(11, 2) NOT NULL, notes VARCHAR(512) NOT NULL, traded SMALLINT DEFAULT NULL, INDEX IDX_CBDA92AB1373ACC9 (ticker_performance_id), INDEX IDX_CBDA92ABCDCDB68E (setup_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE daily_prediction_tag (daily_prediction_id INT NOT NULL, tag_id INT NOT NULL, INDEX IDX_5D7E6A4E961DA428 (daily_prediction_id), INDEX IDX_5D7E6A4EBAD26311 (tag_id), PRIMARY KEY(daily_prediction_id, tag_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE daily_prediction');
        $this->addSql('DROP TABLE daily_prediction_tag');
